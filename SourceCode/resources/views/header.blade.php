<div id="header">
			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> 572 Lạc Long Quân,Tây Hồ, Hà Nội</a></li>
						<li><a href=""><i class="fa fa-phone"></i> 091 558 70 29 </a></li>
					</ul>
				</div>
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="index.html" id="logo"><img src="source/assets/dest/images/logo-1.png" width="250px" alt="" height="120px"></a>
				</div>
