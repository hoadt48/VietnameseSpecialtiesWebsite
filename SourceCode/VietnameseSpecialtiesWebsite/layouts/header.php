...
<html>
    <head>
        <title>VietnameseSpecialtiesWebsite : Đồ án tốt nghiệp</title>
        <meta charset="utf-8">
                    ...
                    <div class="container">
                        <div class="row clearfix">
                            <div class="col-md-6" id="header-text">
                                <a>Admin</a><b>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do </b>
                            </div>
                            <div class="col-md-6">
                                    ...
                                    <li class="clearfix">
                                        <a href="san-pham.php?id=<?php echo $item['id'] ?>">
                                            ...
                                            <div class="info pull-right">
                                                ...
                                                <b class="price">Giảm giá: <?php echo $item['sale'] ?> đ</b><br>
