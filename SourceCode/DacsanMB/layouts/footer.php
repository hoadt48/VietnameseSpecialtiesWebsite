                    ...
                    <div class="container-pluid">
                        <div class="container">
                            <div class="col-md-3" id="ft-about">
                                ...
                                <p>Hãy đến với " Đặc Sản Miền Bắc " để nhớ lại hương vị quê hương</p>
                            </div>
                            ...
                            <div class="col-md-3" id="footer-support">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <p><i class="fa fa-home" style="font-size: 16px;padding-right: 5px;"></i> 54 Triều Khúc - Thanh Xuân - Hà Nội</p>
                                        <p><i class="sp-ic fa fa-mobile" style="font-size: 22px;padding-right: 5px;"></i> 0964499835</p>
                                        <p><i class="sp-ic fa fa-envelope" style="font-size: 13px;padding-right: 5px;"></i>hoadoquyenpt@gmail.com</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
